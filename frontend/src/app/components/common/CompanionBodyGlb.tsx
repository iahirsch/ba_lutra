...
/** Body mesh: morph targets + runtime fur01/fur02 material colors. */
export function CompanionBody({ bodyMorphs, furColor }: CompanionBodyProps) {
  ...
  const scene = useMemo(() => {
    ...
    return cloned;
  }, [source, morphKey, resolvedFurColor]);
